...
const cards = [
  {
    ...
    description: "Harness facial expression detection to uncover how you're really feeling in the moment. This tool uses your camera to analyze your emotions and provide insights into your emotional state.",
  ...
  {
    title: "About us",
    description: "Discover how we aim to empower individuals to understand and manage their emotions effectively. Learn about our mission, vision, and the team behind Wellness Way.",
    image: "/placeholder.svg?height=240&width=280&text=About+Us",
    path: "/about",
  },
  {
